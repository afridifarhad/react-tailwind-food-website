...
function Navbar() {
  return (
    ...
    <nav  className='flex justify-between px-5 p-2'>
      ...
      <h2 className='font-bold text-gray-600 text-lg'>wow food</h2>
      </div>

     <div className='flex gap-x-5 justify-center items-center'>

      <h2 className='text-gray-600 hover:text-pink-800 hover:cursor-pointer'>Home</h2>
      <h2 className='text-gray-600 hover:text-pink-800 hover:cursor-pointer'>About</h2>
      <h2 className='text-gray-600 hover:text-pink-800 hover:cursor-pointer'>Food</h2>
      <h2 className='text-gray-600 hover:text-pink-800 hover:cursor-pointer'>Contact</h2>
     </div>
